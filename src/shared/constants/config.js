...
export const GITHUB_CONFIG = {
  changelogUrl: "https://raw.githubusercontent.com/Raruu/9router/refs/heads/master/CHANGELOG.md",
  donateUrl: "https://9router.com/api/donate",
};

// Updater configuration
export const UPDATER_CONFIG = {
  npmPackageName: "@raruu/9router",
  installCmd: "npm i -g @raruu/9router",
  installCmdLatest: "npm i -g @raruu/9router@latest --prefer-online",
