...
export const TABLES = {
  ...
  apiKeys: {
    columns: {
      ...
      machineId: "TEXT",
      isActive: "INTEGER DEFAULT 1",
      limitType: "TEXT DEFAULT 'none'",
      tokenLimit: "INTEGER DEFAULT 0",
      usedTokens: "INTEGER DEFAULT 0",
      requestLimit: "INTEGER DEFAULT 0",
  ...
  usageHistory: {
    ...
    indexes: [
      ...
      "CREATE INDEX IF NOT EXISTS idx_uh_ttft ON usageHistory(ttft)",
      "CREATE INDEX IF NOT EXISTS idx_uh_total_latency ON usageHistory(totalLatency)",
    ],
  },
  usageDaily: {
    columns: {
