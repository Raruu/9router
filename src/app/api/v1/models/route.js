...
// every prefix a member could carry back to one — see @/lib/providerPrefixMap.

// Combo capability merging lives in open-sse/providers/comboCapabilities.js so
// the dashboard's model-detail endpoint can reuse it without pulling this
// route's provider connections and live-catalog resolvers along with it.
// Re-exported because tests/unit/combo-capabilities-merge.test.js imports it
// from here.
export { mergeMemberCapabilities };
