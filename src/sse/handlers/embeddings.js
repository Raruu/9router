  ...
  while (true) {
    ...
    if (!credentials || credentials.allRateLimited) {
      if (credentials?.allRateLimited) {
        ...
        log.warn("EMBEDDINGS", `[${tag}] ${errorMsg} (${credentials.retryAfterHuman})`);
      ...
      log.warn("EMBEDDINGS", "No more accounts available", { provider: providerDisplayLabel(provider, credentials?.providerSpecificData) });
