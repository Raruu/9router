...
export const MODEL_CAPABILITIES = {
  ...
  // via OpenAI Responses input_image; reasoning supports up to xhigh. Every 1.2
  // variant (plain / contributor / free, with or without a vendor prefix) shares
  // the same 1M window; the "*muse*spark*" pattern below catches any variant not
  // listed here.
...
export const PATTERN_CAPABILITIES = [
  ...
  // Claims every Muse Spark variant, so the Meta Muse entries below only see
  // Glimmer and other Muse models.
 ...
 * @param {{ getCapabilities?: Function,
 *           getModalities: (provider: string, model: string) => object|null,
