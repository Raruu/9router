...
describe("Claude → Kiro (direct route)", () => {
  ...
  it("keeps the Claude system instruction in user content without top-level systemPrompt", () => {
    const out = C2K({
  ...
  it("keeps the replayed system instruction stable inside user content", () => {
    const first = C2K({
