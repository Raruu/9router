...
describe("bug: Claude → OpenAI bridge data loss", () => {
  ...
  // Fixed by the tool-result image forwarding work: the tool message no longer
  // stringifies the image array into raw JSON (image travels in a following
  // user message, see agent-client-fixes.test.js).
